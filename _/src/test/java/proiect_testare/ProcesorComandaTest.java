...
class ProcesorComandaTest {
    ...
    public void testStructural_MultipleConditionCoverage_Exceptii() {
        ...
        assertThrows(IllegalArgumentException.class, () -> procesor.calculeazaPretFinal(null, 1, false, 1.0)); // prima
        assertThrows(IllegalArgumentException.class, () -> procesor.calculeazaPretFinal(new double[]{}, 1, false, 1.0)); // a doua
        assertThrows(IllegalArgumentException.class, () -> procesor.calculeazaPretFinal(new double[]{10.0}, 1, false, -1.0)); // a treia
        assertThrows(IllegalArgumentException.class, () -> procesor.calculeazaPretFinal(new double[]{10.0}, -1, false, 1.0)); // a patra
    }
